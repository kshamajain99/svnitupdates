...
public class DepartmentContactDetails extends Activity {
	 ...
	 ExpandableListView expandableListView;
	    ...
	    List<String> tags = Arrays.asList("appmech","appchem","appmh","appphy","civil","chem","comp","trical","tronic","mech");
	    @Override
	    protected void onCreate(Bundle savedInstanceState) {
			...
			try {
				...
				XmlPullParser parser = pullParserFactory.newPullParser();
				    ...
				    InputStream in_s = getApplicationContext().getAssets().open("departmentContacts.xml");
	        ...
	        expandableListDetail = ContactsData.getDepartmentData();
