...
public class AdminContactDetails extends Activity {
	 ...
	 ExpandableListView expandableListView;
	    ...
	    List<String> tags = Arrays.asList("dean","registrar","acad","other");
	    @Override
	    protected void onCreate(Bundle savedInstanceState) {
			...
			try {
				...
				XmlPullParser parser = pullParserFactory.newPullParser();
				    ...
				    InputStream in_s = getApplicationContext().getAssets().open("adminContacts.xml");
	        ...
	        expandableListDetail = ContactsData.getAdminData();
